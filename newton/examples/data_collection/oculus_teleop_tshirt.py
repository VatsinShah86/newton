...
#
# Franka Panda robot with a T-shirt on the ground, driven by Oculus Quest
# controller teleoperation via QuestStream. End-effector pose targets are
# accumulated from per-frame deltas and solved via IK; joint positions are
# tracked by Featherstone PD control. Cloth is simulated by VBD with
# full self-contact.
#
